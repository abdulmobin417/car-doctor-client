    ...
    <>
      <li>
        <NavLink
          className={({ isActive }) =>
            isActive
              ? "text-[#FF3811] font-medium rounded-none border-b-2 border-[#FF3811] pb-2"
              : ""
          }
          to="/"
        >
      ...
      {user ? (
        ...
        <div className="flex items-center">
          <Link to="/login" className="hidden sm:block">
            <button className="text-[#FF3811] text-lg font-semibold px-7 py-3 border border-[#FF3811] rounded ml-2">
              Login
            </button>
          </Link>
            ...
            <details className="dropdown">
              ...
              <ul className="p-2 shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-36 absolute right-0">
                ...
                <li className="flex items-center sm:hidden">
                  <Link to="/login">
                    <button className="px-4 py-2 text-white bg-[#FF3811] rounded-md">
                      Login
                    </button>
                  </Link>
                </li>
  ...
  return (
    <div className="flex items-center justify-between my-12">
      ...
      <div className="hidden lg:block">
        <ul className="text-[#444] font-semibold text-lg flex gap-10">
          {navItems}
        </ul>
      </div>
