...
import instagram from '../../../assets/images/team/instagram.png'
  ...
  return (
    <div>
      <div className="space-y-5 mb-12 text-center">
        ...
        <h1 className="text-[#151515] text-[45px] font-bold">Meet Our Team</h1>
      ...
      <div className='flex flex-wrap lg:flex-nowrap justify-center lg:justify-between gap-6'>
        <div className="max-w-[348px] p-4 border border-[#E8E8E8] rounded-lg">
          <div className="max-w-[314px] h-[293px]">
            <img
              src={img1}
          ...
          <div className="text-center">
            <h3 className="text-[#444] text-2xl font-bold mt-5 mb-2">
              Car Engine Plug
            </h3>
            <p className="text-[#737373] text-xl font-semibold mb-4">
              Engine Expert
            </p>
